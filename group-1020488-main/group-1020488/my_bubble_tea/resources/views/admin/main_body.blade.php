<div class="main-panel">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <span class="pl-2">Estelle Briand</span>
                      </td>
                      <td> 02312 </td>
                      <td> $14,500 </td>
                      <td> Dashboard </td>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <span class="pl-2">Romaric Bryan</span>
                      </td>
                      <td> 02312 </td>
                      <td> $14,500 </td>
                      <td> Website </td>
    ...
    <footer class="footer">
      <div class="d-sm-flex justify-content-center justify-content-sm-between">
        <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Integrated by Yann DIPITA</span>
        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Check my github <a href="https://github.com/kingcrud12?tab=repositories" target="_blank">Admin panel</a> Integrated by Yann DIPITA</span>
      </div>
    </footer>
    <!-- partial -->
  </div>
